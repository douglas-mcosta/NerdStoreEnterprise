...
{
    public class PagamentoCartaoCreditoFacede : IPagamentoFacede
    {
        private readonly PagamentoConfig _pagamentoConfig;

        public PagamentoCartaoCreditoFacede(IOptions<PagamentoConfig> pagamentoConfig)
        {
        ...
        {
            var nerdsPagSvc = new NerdsPagService(_pagamentoConfig.DefaultApiKey, _pagamentoConfig.DefaultEncryptionApiKey);
        ...
        {
            var nerdsPagService = new NerdsPagService(_pagamentoConfig.DefaultApiKey, _pagamentoConfig.DefaultEncryptionApiKey);
