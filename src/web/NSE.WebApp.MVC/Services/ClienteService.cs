...
namespace NSE.WebApp.MVC.Services
{
    ...
    public class ClienteService : Service, IClienteService
    {
        ...
        public ClienteService(HttpClient httpCliente, IOptions<AppSettings> settings)
        {
            _httpCliente = httpCliente;
            _httpCliente.BaseAddress = new Uri(settings.Value.ClienteUrl);
        }


        public async Task<EnderecoViewModel> ObterEndereco()
        {
            var response = await _httpCliente.GetAsync("cliente/endereco");
        ...
        public async Task<ResponseResult> AdicionarEndereco(EnderecoViewModel endereco)
        {
            ...
            var response = await _httpCliente.PostAsync("/cliente/endereco",enderecoContent);
